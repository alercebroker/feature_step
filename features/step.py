...
class FeaturesComputer(GenericStep):
    ...
    **step_args : type
    ...
    def compute_features(self, detections: pd.DataFrame):
        ...
        **Example:**
        ...
        features = self.features_computer.compute_features(clean_lightcurves)
        return features
    ...
    def execute(self, messages):
        ...
        features = self.compute_features(detections)
